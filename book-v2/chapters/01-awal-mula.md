...
Seorang hominid di Afrika Timur, dua juta tahun yang lalu, memegang batu tajam pertama. Gestur itu—tanpa disadari—merupakan cikal bakal segala kecerdasan buatan. Sebelum ada Neural Network, sebelum ada Transformer, sebelum ada Large Language Model yang bisa menulis esai atau mendeteksi kanker—sudah ada insting dasar yang sama: membuat alat untuk memperluas kemampuan diri.

Batu tajam itu tidak intelligent dalam arti modern. Ia tidak bisa belajar, beradaptasi, atau generatif. Tapi ia mewakili principle yang akan menemani manusia sepanjang sejarah: kalau tubuh tidak cukup, buatlah extension. Kalau tangan tidak cukup kuat, buatlah kapak. Kalau ingatan tidak cukup luas, buatlah tulisan.
...
Ketika tangan manusia belajar membentuk batu, otak pun berubah. Neuron-neuron yang sebelumnya tidak teraktivasi mulai terhubung. Plasticity otak—kemampuan untuk berubah berdasarkan pengalaman—menjadi feedback loop: alat mengubah otak, otak yang berubah membuat alat lebih baik.
...
Difference Engine, yang sebagian berhasil dibangun kemudian, dirancang untuk menghitung tabel matematika secara otomatis, eliminating human error. Tapi Analytical Engine—yang tidak pernah selesai dibangun karena keterbatasan teknologi waktu itu—adalah visi yang lebih ambisius: mesin universal yang bisa melakukan apapun yang bisa dihitung.

Analytical Engine memiliki komponen yang recognizable sebagai komputer modern:
- **Memory**: untuk menyimpan angka
- **Mill**: untuk melakukan operasi aritmatika
...
Di sinilah Augusta Ada Lovelace masuk. Puteri penyair Lord Byron ini, yang juga matematikawan, menulis "notes" yang jauh lebih panjang dari paper asli Babbage. Dalam catatan itu, ia meramalkan bahwa machine bisa "weave algebraic patterns just as the Jacquard loom weaves flowers and leaves."
