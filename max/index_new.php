<?php
/**
 * Max Articles Blog - Reader dari Airtable (Table Baru)
...
$AIRTABLE_TABLE_ID = 'tblArticles'; // <-- GANTI DENGAN TABLE ID BARU ANDA
...
<body>
    ...
    <footer>
        <p>Max Articles Blog &copy; 2026 | Data dari <a href="https://airtable.com" target="_blank">Airtable</a> | <a href="https://github.com/labsdigital/hermes" target="_blank">GitHub</a></p>
    </footer>
</body>
</html>
