---
name: polli-cli
description: Generate images, text, audio, video, and transcribe speech via Pollinations API using polli CLI. Use when asked to generate media, call pollinations.ai, check pollen balance, list models, manage API keys, inspect quests, or run polli commands.
