# Bab 9 — Etika di Persimpangan: Menyelaraskan Nilai

## Hook

Siapa yang menetapkan etika untuk AI? Programmer yang menulis kode? CEO yang menentukan product roadmap? Pemerintah yang membuat regulasi? Atau masyarakat yang terkena dampaknya?

Jawaban atas pertanyaan ini menentukan apakah AI menjadi force untuk emancipation atau instrument of control.

## Prinsip AI yang Bertanggung Jawab

Industri AI telah mengembangkan sekumpulan prinsip: transparency, accountability, fairness, privacy, safety. Prinsip-prinsip ini—dalam teori—mengarah pada pengembangan yang responsible.

Tapi implementasi sering kali gap dari intention. "Transparency" berarti apa jika algorithm proprietary? "Accountability" berarti apa jika kesalahan distributed across multiple stakeholders? "Fairness" berarti apa jika definisi fairness itu sendiri contested?

Prinsip-prinsip tanpa enforcement mechanism hanyalah rhetoric.
...
Gap ini menciptakan vacuum: inovasi tanpa guardrails, power tanpa accountability.

Beberapa approaches:
- **Ex-ante regulation**: rules before deployment (EU AI Act)
- **Ex-post liability**: accountability after harm (tort law)
- **Self-regulation**: industry codes of conduct
- **Technical standards**: certifiable safety properties

Tiap approach memiliki trade-offs. Ex-ante protection innovation. Ex-post terlalu late untuk irreversible harm. Self-regulation often captured by industry interests.
...
Value alignment—menyelaraskan AI goals dengan human values—adalah masalah yang lebih dalam dari sekadar "bias in, bias out."

Masalahnya: human values tidak uniform. Berbeda culture, berbeda价值观. Berbeda stakeholder, berbeda priorities.

Dan lebih fundamental: human values seringkali inconsistent even within individual. Seseorang bisa valued autonomy dan safety simultaneously, tapi ketika conflicting—mana yang prioritaskan?

AI tidak bisa menyelesaikan philosophical debate tentang values. Ia hanya bisa menginkorporasikan some value system—and that choice itself is political.

Contohnya: content moderation. Platform harus decide apa yang allowed. Setiap decision reflective values—free speech vs harm prevention. Tidak ada neutral solution.
...
Dua pendekatan filosofis terhadap AI risk:

**Precautionary**: better safe than sorry. Hentikan atau regulate ketat sampai safety terjamin. Risks of inaction outweigh risks of restraint.

**Promethean**: fire brings both destruction dan civilization. Embrace AI development, manage risks as they come. Risks of restriction outweigh risks of action.
...
## Self-Regulation Korporat

Banyak tech companies membentuk internal ethics boards, publish AI principles, engage dalam multi-stakeholder initiatives.

Tapi incentive structures sering conflicts. Shareholder pressure untuk profit bisa override ethical considerations. "Move fast and break things" culture sulit reconcile dengan "do no harm."

Yang diperlukan adalah accountability mechanisms external: regulation, litigation, public scrutiny.
...
Etika bukan penghalang kemajuan—ia adalah kompas. Tapi kompas memerlukan destinasi yang jelas. Dan destinasi itu tidak bisa ditentukan hanya oleh teknokrat.

Bab berikutnya akan membawa pandangan ke horizon yang lebih jauh: apa yang terjadi ketika AI melampaui cognitive abilities manusia?

---

*Bab selanjutnya: Bab 10 — Horizon yang Berubah: AGI dan Beyond*
